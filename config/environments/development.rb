...
Rails.application.configure do
  ...
  ENV['FACEBOOK_OAUTH_CLIENT_ID'] = Rails.application.credentials.dig(:facebook_oauth_client_id)

  ENV['FACEBOOK_OAUTH_CLIENT_SECRET'] = Rails.application.credentials.dig(:facebook_oauth_client_secret)
  ...
  config.hosts << "a223-45-250-249-250.ngrok.io"
